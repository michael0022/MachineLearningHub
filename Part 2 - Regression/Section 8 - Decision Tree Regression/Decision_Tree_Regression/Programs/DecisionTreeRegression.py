# -*- coding: utf-8 -*-
"""
Created on Wed Sep 26 13:02:19 2018
...
plt.title("Truth of Bluff (Descision Tree Regression Model)")
plt.xlabel("Position Level")
plt.ylabel("Salary")
plt.show()

# Visualizing the polynomial linear regression results with enhanced resolution
