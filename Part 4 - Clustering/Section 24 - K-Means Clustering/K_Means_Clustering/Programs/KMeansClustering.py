# -*- coding: utf-8 -*-
"""
Created on Sat Oct 27 15:18:36 2018
...
# Using the Elbow method to find the number of clustering
...
for i in range(1, 11):
    ...
    kmeans.fit(X)
    wcss.append(kmeans.inertia_) # finding distance between points and cluster
